...
type JWTInterface interface {
	GenerateJWT(userID uint, email string) map[string]any
	GenerateToken(id uint, email string) string
...
func (j *JWT) GenerateJWT(userID uint, email string) map[string]any {
	var result = map[string]any{}
	var accessToken = j.GenerateToken(userID, email)
...
func (j *JWT) GenerateToken(id uint, email string) string {
